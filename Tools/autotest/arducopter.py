...
#        self.takeoffAndMoveAway()
    ...
    def RTLSpeed(self):
        ...
        self.set_parameters({
            'WP_ACCEL': wpnav_accel_mss,
            'RTL_SPEED_MS': rtl_speed_ms,
            'WP_SPEED': wpnav_speed_ms,
        })
        self.change_mode('LOITER')
        self.wait_ready_to_arm()
        self.arm_vehicle()
    ...
    def WP_SPEED(self):
        '''ensure resetting WP_SPEED during a mission works'''
    ...
    def WP_SPEED_UP(self):
        ...
        start_speed_ms = self.get_parameter('WP_SPEED_UP')
        ...
        for speed_ms in 7, 8, 7, 8, 6, 2:
            self.set_parameter('WP_SPEED_UP', speed_ms)
    ...
    def WP_SPEED_DN(self):
        ...
        start_speed_ms = self.get_parameter('WP_SPEED_DN')
        self.wait_climbrate(-start_speed_ms-1, -start_speed_ms+1, minimum_duration=minimum_duration)

        for speed_ms in 7, 8, 7, 8, 6, 2:
            self.set_parameter('WP_SPEED_DN', speed_ms)
            self.wait_climbrate(-speed_ms-1, -speed_ms+1, minimum_duration=minimum_duration)
        self.do_RTL()
    ...
    def Landing(self):
        ...
        check_landing_speeds(
            self.get_parameter("WP_SPEED_DN") / 100,  # cm/s -> m/s
...
""")
    ...
    def RTLStoppingDistanceSpeed(self):
        ...
        wp_speed = self.get_parameter('WP_SPEED')
