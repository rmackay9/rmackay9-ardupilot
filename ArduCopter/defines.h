...
enum tuning_func {
    ...
    TUNING_ACRO_RP_RATE =               25, // acro controller's P term.  converts pilot input to a desired roll, pitch or yaw rate
    ...
    TUNING_ACRO_YAW_RATE =                40, // acro controller's P term.  converts pilot input to a desired roll, pitch or yaw rate
