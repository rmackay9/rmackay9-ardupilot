...
const AP_Param::GroupInfo ParametersG2::var_info2[] = {
    ...
    // @Increment: 0.1
    // @User: Standard
    AP_GROUPINFO("PILOT_ACC_Z", 16, ParametersG2, pilot_accel_d_mss, PILOT_ACC_Z_DEFAULT),
    ...
    // @Increment: 0.1
    // @User: Standard
    AP_GROUPINFO("PILOT_SPD_UP", 17, ParametersG2, pilot_speed_up_ms, PILOT_SPD_UP_DEFAULT),
    ...
    // @Increment: 0.1
    // @User: Standard
    AP_GROUPINFO("PILOT_SPD_DN", 18, ParametersG2, pilot_speed_dn_ms, 0),
    ...
    // @Range: 0.0 10.0
    // @Increment: 0.1
    AP_GROUPINFO("PILOT_TKO_ALT_M", 19, ParametersG2, pilot_takeoff_alt_m, PILOT_TKO_ALT_M_DEFAULT),
