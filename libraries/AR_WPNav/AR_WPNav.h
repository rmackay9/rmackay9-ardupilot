...
public:
    ...
    bool set_desired_location(const struct Location& destination, float next_leg_bearing_cd = AR_WPNAV_HEADING_UNKNOWN, bool origin_as_current_loc = false)  WARN_IF_UNUSED;
