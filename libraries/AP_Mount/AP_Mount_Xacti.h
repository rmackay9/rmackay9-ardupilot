...
private:
    ...
    FUNCTOR_DECLARE(param_string_cb, bool, AP_UAVCAN*, const uint8_t, const char*, AP_UAVCAN::string &);
    ...
    bool handle_param_get_set_response_string(AP_UAVCAN* ap_dronecan, const uint8_t node_id, const char* name, AP_UAVCAN::string &value);
    ...
    bool set_param_string(const char* param_name, const AP_UAVCAN::string& param_value);
