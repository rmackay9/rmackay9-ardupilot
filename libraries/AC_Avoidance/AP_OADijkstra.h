...
public:
    ...
    void set_fence_margin(float margin) { _polyfence_margin = margin; }
...
private:
    ...
    bool _polyfence_with_margin_ok = false;
    ...
    // requires create_polygon_fence_with_margin to have been run
    // returns true on success
    bool update_visgraph(AP_OAVisGraph& visgraph, const AP_OAVisGraph::OAItemID& oaid, const Vector2f &position, bool add_extra_point = false, Vector2f extra_point = Vector2f(0,0));
    ...
    uint8_t shortest_path_numpoints();
