...
# define AP_SERIALMANAGER_CONSOLE_BAUD          115200
 ...
 # define AP_SERIALMANAGER_CONSOLE_BUFSIZE_TX   128
#else
 // use a bit less for non-HIL operation
 # define AP_SERIALMANAGER_CONSOLE_BUFSIZE_RX   256
 # define AP_SERIALMANAGER_CONSOLE_BUFSIZE_TX   256
#endif
...
#define AP_SERIALMANAGER_FRSKY_BAUD             9600
