...
#define AP_SERIALMANAGER_HYBRID_BAUD           9600
#define AP_SERIALMANAGER_HYBRID_BUFSIZE_RX     70
#define AP_SERIALMANAGER_HYBRID_BUFSIZE_TX     70
