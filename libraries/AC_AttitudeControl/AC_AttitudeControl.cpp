...
const AP_Param::GroupInfo AC_AttitudeControl::var_info[] = {
    ...
    // 2 was SLEW_YAW (in cdeg/s) - moved to SLEW_YAW_MAX in deg/s
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("SLEW_YAW_MAX", 25, AC_AttitudeControl, _slew_yaw_max_degs, AC_ATTITUDE_CONTROL_SLEW_YAW_DEFAULT_DEGS),
...
float AC_AttitudeControl::get_slew_yaw_max_rads() const
{
    if (!is_positive(_ang_vel_yaw_max_degs)) {
        return radians(_slew_yaw_max_degs);
    }
    return MIN(radians(_ang_vel_yaw_max_degs), radians(_slew_yaw_max_degs));
}
...
void AC_AttitudeControl::convert_parameters()
{
    ...
    static const AP_Param::ConversionInfo conversion_info_001[] = {
        ...
        { 108, 128, AP_PARAM_FLOAT, "Q_A_SLEW_YAW_MAX" },   // SLEW_YAW moved to SLEW_YAW_MAX in deg/s
    ...
    static const AP_Param::ConversionInfo conversion_info_001[] = {
        ...
        { 53, 128, AP_PARAM_FLOAT, "ATC_SLEW_YAW_MAX" },  // SLEW_YAW moved to SLEW_YAW_MAX in deg/s
    ...
    static const AP_Param::ConversionInfo conversion_info_001[] = {
        ...
        { 102, 128, AP_PARAM_FLOAT, "ATC_SLEW_YAW_MAX" }, // SLEW_YAW moved to SLEW_YAW_MAX in deg/s
