...
local roll_pitch_accel_max = 1      -- horizontal acceleration max in m/s/s
...
local climb_pause_sec = 5           -- pause for this many seconds during each interval
...
local wall_dist_target = 4          -- target distance to wall
