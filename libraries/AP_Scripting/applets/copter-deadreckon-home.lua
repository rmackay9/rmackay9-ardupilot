...
local wp_speed_up = Parameter("WP_SPEED_UP")           -- maximum climb rate in m/s from WP_SPEED_UP
local wp_accel_z = Parameter("WP_ACCEL_Z")             -- maximum vertical acceleration in m/s from WP_ACCEL_Z
