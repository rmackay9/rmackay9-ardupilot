...
const AP_Param::GroupInfo AP_BattMonitor_TIBQ76952::var_info[] = {
    ...
    // @Units: A
    // @User: Advanced
    AP_GROUPINFO("MAX_AMPS", 27, AP_BattMonitor_TIBQ76952, max_amps, HAL_BATTMON_INA239_MAX_CURRENT),
    ...
    // @Units: Ohm
    // @User: Advanced
    AP_GROUPINFO("SHUNT", 28, AP_BattMonitor_TIBQ76952, rShunt, HAL_BATTMON_INA239_SHUNT_RESISTANCE),
