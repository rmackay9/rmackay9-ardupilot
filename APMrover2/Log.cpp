...
// Write a dodge avoidance package
void Rover::Log_Write_Avoidance()
{
    ...
    struct log_Avoidance pkt = {
        ...
        dist_left_cm          : (uint16_t)(obstacle.angle * 100.0f),
        dist_right_cm         : (uint16_t)(obstacle.distance * 100.0f),
...
const LogStructure Rover::log_structure[] = {
    ...
    { LOG_AVOIDANCE_MSG, sizeof(log_Avoidance),
      "AVOD", "QfHHHbHCb",  "TimeUS,LatAcc,R1Dist,R2Dist,DCnt,TAng,TTim,Spd,Thr", "somm-hsm-", "F0BB-0CB-" },
