...
void Rover::read_rangefinders(void)
{
    ...
    // Log range finder data
    if (should_log(MASK_LOG_RANGEFINDER) && (rangefinder.num_sensors() > 0)) {
...
// update proximity sensor and dodge avoidance
void Rover::update_proximity()
{
